...
public class MyDatabase extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase sqLiteDatabase) {
        ...
        String query3 = "create table orderplace(username text,fullname text,address text,contactno text,pincode int, date text,time text,price float, otype text)";
    ...
    public  int login(String username,String password){
        ...
        Cursor c = db.rawQuery("select * from users where username = ? and password = ?",credentials);
        if(c.moveToFirst()){
            result = 1;
        }
        return result;
